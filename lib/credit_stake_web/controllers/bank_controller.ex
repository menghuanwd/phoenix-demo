defmodule CreditStakeWeb.BankController do
  ...
  def swagger_definitions do
	  %{
		  BaiscBank: swagger_schema do
			...
			Bank: swagger_schema do
				title "Bank"
        property(:data, Schema.ref(:BaiscBank))
        end,
	    Banks: swagger_schema do
		    title "Banks"
  ...
  swagger_path :show do
	  ...
	  parameter :id, :path, :uuid, "Bank ID", required: true, example: "162bf201-55c9-4dff-81ec-4ac42288eb1e"
	  produces("application/json")
